...
.profile {
  ...
  font-family: var(--font-nasalization);
    ...
    <div class="diet">
      ...
      <div class="login-button"><div class="profile">Profile</div></div>
      <div class="nav-bar">
        <div class="nav-bar1">
            <style>
                a{
      ...
      <img class="diet-child14" alt="" src="./public/whey.png" /><img
        class="diet-child15"
        alt=""
        src="./public/c4-pre-workout.png"
      /><img class="group-icon" alt="" src="./public/Creatine.png" /><img
        class="x38-1-icon1"
        alt=""
        src="./public/Dumbbells.png"
      /><img class="x38-1-icon2" alt="" src="./public/All-in-one Bar.png" />
