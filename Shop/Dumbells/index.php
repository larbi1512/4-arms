...
?>
  <body>
    <div class="diet">
      ...
      <div class="product-description-dumbbells-container">
        ...
        <ul class="dumbbells-are-a-versatile-fitn">
          <li class="metal-grip-on-both-ends">
            <span
              >Dumbbells are a versatile fitness accessory that are used to
          ...
          <li class="metal-grip-on-both-ends">
            <span
              >Various sizes and weights suitable for different exercises</span
            >
          </li>
        </ul>
      ...
      <img
        class="studio-portrait-bearded-brutal-icon"
        alt=""
        src="./public/studioportraitbeardedbrutalmaleisolatedgraybackgroundremovebgpreview-1@2x.png"
      />
