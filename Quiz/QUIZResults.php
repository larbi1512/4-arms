...
<html>
  ...
  <body>
    <div class="quiz-question1">
      <img class="red-lines-icon3" alt="" src="./public/red-lines3.svg" /><img
        class="red-lines-icon4"
        alt=""
        src="./public/red-lines4.svg"
      /><img class="red-lines-icon5" alt="" src="./public/red-lines4.svg" /><img
        class="vector-icon"
        alt=""
        src="./public/vector-2.svg"
      /><img
        class="quiz-question-child2"
        alt=""
      ...
      <div class="let-s-start">
        <a href="../signup_login/signup.php">Let ‘s Start Now!</a>
      </div>
    </div>
  </body>
</html>
